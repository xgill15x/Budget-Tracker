...
(function (global, factory) {
  ...
  _exports.default = _exports.DeleteIcon = void 0;
  ...
  var DeleteIcon = /*#__PURE__*/function (_React$Component) {
    _inherits(DeleteIcon, _React$Component);

    var _super = _createSuper(DeleteIcon);
    ...
    _createClass(DeleteIcon, [{
      ...
      value: function classes() {
        var classes = ['shapla-delete-icon'];
  ...
  _exports.DeleteIcon = DeleteIcon;

  _defineProperty(DeleteIcon, "defaultProps", {
    size: 'normal',
    ariaLabel: 'close',
    fixed: false,
  ...
  _defineProperty(DeleteIcon, "propTypes", {
    size: _propTypes.default.oneOf(['normal', 'small', 'medium', 'large']),
